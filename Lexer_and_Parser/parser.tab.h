...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    keyword = 258,                 /* keyword  */
    print_kw = 259,                /* print_kw  */
    if_kw = 260,                   /* if_kw  */
    else_kw = 261,                 /* else_kw  */
    elif_kw = 262,                 /* elif_kw  */
    define_kw = 263,               /* define_kw  */
    bool_kw = 264,                 /* bool_kw  */
